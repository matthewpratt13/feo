...
use crate::{
    ...
    item::{
        ConstantVarDef, EnumDef, ExternCrateDecl, FunctionSig, FunctionWithBlock, ImportDecl,
        InherentImplBlock, ModWithBody, ModWithoutBody, PathSubsetRecursive, PathWildcard,
        PathWithAsClause, StaticVarDef, StructDef, TraitDef, TraitImplBlock, TupleStructDef,
        TypeAliasDef,
    },
    pattern::Pattern,
    ty::Type,
